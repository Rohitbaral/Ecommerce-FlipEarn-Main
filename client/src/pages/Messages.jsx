    ...
    <div className='mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32'>
      <div className='py-10'>
       ...
       <div className='relative max-w-xl mb-8'>
        ...
        onChange={(e)=>setSearchQuery(e.target.value)} className='w-full
        pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-indigo-500'/>
       </div>
        ...
        text-center'>
             ...
             <h3 className='text-xl font-medium text-gray-800 mb-2'>
              ...
              <p className='text-gray-600'>
                ...
                "Start a conversation by viewing a listing and clicking 'Chat with a Seller'"}
              </p>
        </div>
       ): (
        ...
        divide-y divide-gray-200'>
         {filteredChats.map((chat)=>{
          ...
          return (
            ...
            key={chat.id} className='w-full p-4 hover:bg-gray-50
            transition-colors text-left'>
              <div className='flex items-start space-x-4'>
                    <div className='flex-shrink-0'>
                      <img src={chatUser?.image} alt={chat?.chatUser?.name} className='
                    ...
                    <div className='flex-1 min-w-0'>
                       ...
                       <p className={`text-sm truncate ${!chat.isLastMessageRead && 
                        ...
                        "text-gray-500"}`}>{chat.lastMessage || 'No message yet'}</p>
                    </div>
              </div>
            </button>
          )
